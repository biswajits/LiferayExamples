...
/**
 * The persistence utility for the student entry service. This utility wraps {@link StudentEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StudentEntryUtil {
	 ...
	 */
	public static StudentEntry update(StudentEntry studentEntry, boolean merge)
		throws SystemException {
		return getPersistence().update(studentEntry, merge);
	}
	...
	public static StudentEntry update(StudentEntry studentEntry, boolean merge,
		...
		return getPersistence().update(studentEntry, merge, serviceContext);
	}
	...
	*/
	public static net.service.builder.model.StudentEntry create(long studentId) {
	...
	*/
	public static net.service.builder.model.StudentEntry remove(long studentId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.service.builder.NoSuchEntryException {
		return getPersistence().remove(studentId);
	}

	public static net.service.builder.model.StudentEntry updateImpl(
		net.service.builder.model.StudentEntry studentEntry, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(studentEntry, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.service.builder.model.StudentEntry findByPrimaryKey(
		long studentId)
		throws com.liferay.portal.kernel.exception.SystemException,
			net.service.builder.NoSuchEntryException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static net.service.builder.model.StudentEntry fetchByPrimaryKey(
		long studentId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<net.service.builder.model.StudentEntry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StudentEntryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StudentEntryPersistence)PortletBeanLocatorUtil.locate(net.service.builder.service.ClpSerializer.getServletContextName(),
					StudentEntryPersistence.class.getName());

			ReferenceRegistry.registerReference(StudentEntryUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(StudentEntryPersistence persistence) {
	}

	private static StudentEntryPersistence _persistence;
}